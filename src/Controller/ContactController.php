...
final class ContactController extends AbstractController
{
    ...
    public function create(Request $request, EntityManagerInterface $entityManager): Response {
        ...
        // 1. Créer le contact à inserer en base de données
            $contact= new Contact();

        // 2a. Créer le type de formulaire
        ...
        $form->handleRequest($request);
         ...
         if ($form->isSubmitted() && $form->isValid()) {
            ...
            // 6.  Alors inserer le nouveau contact en base de données
            $entityManager->persist($contact); // préparer le requête d'insertion des infos en base de données
